...
const STYLISH_NAME = "—͞To፝֟֟ᴍㅤᏴꫝ֟፝ʙ𝚈";
...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('X-TOM', {
        font: 'Standard',
    ...
    console.log(chalk.green(' 𝐱-𝐓𝐨𝐦♡ 💗 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦 '));
    console.log(chalk.yellow('═══════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting X-TOM system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅𝐱-𝐓𝐨𝐦♡ 💗 bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('𝐱-𝐓𝐨𝐦♡ 💗 BOT INITIALIZATION SUMMARY '));
    console.log(chalk.cyan('═══════════════════════'));
    console.log(telegramLoaded? chalk.green('✅𝐱-𝐓𝐨𝐦 тɛℓɛɢяαм вσт: Active') : chalk.red('❌𝐱-𝐓𝐨𝐦 тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded &&!whatsappLoaded) {
        ...
        console.log(chalk.green('✅ 𝐱-𝐓𝐨𝐦 system is ready and running!\n'));
    }
