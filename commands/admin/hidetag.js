...
module.exports = {
  name: 'hidetag',
  aliases: ['tag', 'sobairetag'],
  description: 'গ্রুপের সবাইকে চুপচাপ মেনশন করা',
  usage: '.tag <মেসেজ> (অথবা মিডিয়াতে রিপ্লাই দিন)',
  category: 'admin',
  groupOnly: true,
  adminOnly: true,
  botAdminNeeded: true,
    ...
    try {
      ...
      if (mediaMessage) {
        ...
        try {
          ...
          const text = args.join(' ') || '*সবাই একটু দেখেন*';
          await sock.sendMessage(extra.from, { text, mentions }, { quoted: msg });
        }
      } else {
      ...
      await extra.reply('❌ *সবাইকে ট্যাগ করা যায়নি!*');
    }
  },
};