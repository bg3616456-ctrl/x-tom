...
module.exports = {
  ...
  description: 'স্টিকার/ইমেজ/ভিডিও ক্রপ করে স্কয়ার স্টিকার বান',
  usage: '.crop (স্টিকার/ইমেজ/ভিডিও তে রিপ্লাই)',
  category: 'general',
  ...
  async execute(sock, msg, args, extra) {
    ...
    try {
      ...
      if (!mediaInfo) {
        return extra.reply('✂️ *স্টিকার*, *ইমেজ* বা *ভিডিও* তে রিপ্লাই দিয়ে.crop কমান্ড ব্যবহার করুন।');
      }
      ...
      if (!mediaMessage) {
        return extra.reply('✂️.crop ক্যাপশন দিয়ে ইমেজ/ভিডিও/স্টিকার পাঠান, অথবা রিপ্লাই দিন।');
      }
      ...
      if (!mediaBuffer) {
        return extra.reply('❌ মিডিয়া ডাউনলোড করতে সমস্যা হয়েছে। আবার চেষ্টা করুন।');
      }

      // Check file size
      if (mediaBuffer.length > MAX_FILE_SIZE) {
        return extra.reply(`❌ ফাইল অনেক বড়: ${(mediaBuffer.length / 1024 / 1024).toFixed(2)}MB (সর্বোচ্চ: ${MAX_FILE_SIZE / 1024 / 1024}MB)`);
      }
      ...
      await extra.reply('❌ স্টিকার ক্রপ করতে সমস্যা হয়েছে! ইমেজ বা ভিডিও দিয়ে চেষ্টা করুন।');
    } finally {
