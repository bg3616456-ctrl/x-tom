...
module.exports = {
  name: 'simage',
  aliases: ['toimg', 'stickertoimg', 'sticker2img', 'svideo', 'স্টিকারইমেজ'],
  category: 'general',
  description: 'স্টিকারকে PNG ইমেজে কনভার্ট করুন',
  usage: '.simage (স্টিকারে রিপ্লাই দিন)',

  async execute(sock, msg, args, extra) {
    try {
      const notStickerMessage = '📎 *স্টিকারে রিপ্লাই দিয়ে `.simage` ব্যবহার করুন!*';
      ...
      await extra.reply('🔄 *স্টিকার কনভার্ট করা হচ্ছে...*');
      ...
      if (!stickerBuffer) {
        return await extra.reply('❌ *স্টিকার ডাউনলোড করতে সমস্যা হয়েছে। আবার চেষ্টা করুন।*');
      }
      ...
      if (isAnimated) {
        ...
        if (mp4Buffer.length > maxSize) {
          throw new Error(`MP4 ফাইল অনেক বড়: ${(mp4Buffer.length / 1024 / 1024).toFixed(2)}MB`);
        }
        ...
        await sock.sendMessage(extra.from, {
          ...
          mimetype: 'video/mp4',
          gifPlayback: true,
          caption: '✅ *এনিমেটেড স্টিকার ভিডিওতে কনভার্ট হয়েছে*'
        }, { quoted: msg });
      } else {
        ...
        await sock.sendMessage(extra.from, {
          image: imageBuffer,
          caption: '✅ *স্টিকার PNG ইমেজে কনভার্ট হয়েছে*'
        }, { quoted: msg });
      }

    } catch (error) {
      console.error('Error in simage command:', error);
      await extra.reply(`❌ *স্টিকার কনভার্ট করতে সমস্যা হয়েছে।*\n\n*এরর:* ${error.message}`);
    }
  }
};